...
from aicli.session_manager import _handle_slash_command, SessionState, perform_interactive_chat
...
class TestSessionLifecycle:
    ...
    def test_perform_interactive_chat_loads_command_history(self, mocker):
        ...
        mocker.patch('aicli.session_manager.prompt', side_effect=EOFError) # Exit loop immediately
        mock_history_instance = mocker.MagicMock(spec=InMemoryHistory)
        mocker.patch('aicli.session_manager.InMemoryHistory', return_value=mock_history_instance)
        ...
        perform_interactive_chat(initial_state=initial_state, session_name="test_session")
