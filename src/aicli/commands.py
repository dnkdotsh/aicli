...
from .prompts import (MEMORY_INTEGRATION_PROMPT, LOG_RENAMING_PROMPT,
...
def consolidate_session_into_memory(engine: AIEngine, model: str, history: list):
...
def handle_quit(args: list, state: "SessionState", cli_history: InMemoryHistory) -> bool:
...
def handle_save(args: list, state: "SessionState", cli_history: InMemoryHistory) -> bool:
